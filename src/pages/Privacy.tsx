  ...
  return <>
    ...
    <div className="texts">
      <section className="text-1">
        ...
        <p>
          1. Verantwortlicher
          Verantwortlich für die Datenverarbeitung auf dieser Website ist:</p>
        ...
        <p>
          ...
          Unsere Website dient ausschließlich der Bereitstellung von Informationen über unser Unternehmen und unsere Dienstleistungen. Wir speichern keine personenbezogenen Daten von Ihnen, solange Sie uns diese nicht freiwillig mitteilen.<br></br>
          Kontaktaufnahme:<br></br>
          Wenn Sie uns per E-Mail, Telefon oder über ein Kontaktformular kontaktieren, verwenden wir Ihre angegebenen Daten (z. B. Name, E-Mail-Adresse, Telefonnummer) ausschließlich zum Zweck der Bearbeitung Ihrer Anfrage. Eine Weitergabe dieser Daten an Dritte erfolgt nicht.
          Sobald Ihre Anfrage vollständig bearbeitet ist und keine gesetzlichen Aufbewahrungspflichten bestehen, werden die von Ihnen mitgeteilten Daten gelöscht.</p>
      </section>
      
      <section className="text-2">
        <p>3. Keine Speicherung von Zugriffsdaten<br></br>
          Beim Besuch unserer Website werden keine personenbezogenen Daten automatisch gespeichert. Wir verwenden keine Cookies, Tracking-Tools oder ähnliche Technologien.<br></br>
        ...
        <p>
          Hinweis: Diese Datenschutzerklärung ist nach deutschem Recht verfasst und an Websites angepasst, die keine Daten speichern und personenbezogene Daten nur zur Kontaktaufnahme nutzen
        </p>
        </section>
    </div>
  </>;
